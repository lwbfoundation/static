    ...
    <PageWrapper data={data}>
      ...
      <Box width={1080} marginX="auto" marginY={16}>
        <Box
          width={1080}
          height={1350}
          backgroundColor="rgb(235,238,230)"
          position="relative"
          marginBottom={16}
        >
          <Box paddingY={10} paddingX={12}>
            <CustomHeading
              fontSize={['6xl', '6xl', '150px', '150px', '80px']}
              body="Coming soon from the Lewis W. Butler Foundation"
            />
          </Box>
          <Box width="100%">
            <HeaderBackgroundImage>
          ...
          <Box paddingY={10} paddingX={12}>
            <CustomHeading
              fontSize={['6xl', '6xl', '150px', '150px', '80px']}
              body="Our first application for design scholarships!"
            />
          </Box>
        ...
        <Box
          width={1080}
          height={1350}
          backgroundColor={theme.colors.orange.brand}
          position="relative"
          marginBottom={16}
        >
          <Box paddingY={12} paddingX={12}>
            <CustomHeading
              fontSize={['6xl', '6xl', '150px', '150px', '150px']}
              marginTop="150px"
              marginBottom="150px"
              color="white"
              body="LWBF design scholarships:"
            />
            <CustomHeading
              fontSize={['6xl', '6xl', '150px', '150px', '150px']}
              color="white"
              body="Application is live!"
            />
          </Box>
